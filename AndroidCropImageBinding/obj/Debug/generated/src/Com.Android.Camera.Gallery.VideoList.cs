...
namespace Com.Android.Camera.Gallery {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.android.camera.gallery']/class[@name='VideoList']"
	[global::Android.Runtime.Register ("com/android/camera/gallery/VideoList", DoNotGenerateAcw=true)]
	public partial class VideoList : global::Com.Android.Camera.Gallery.BaseImageList {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/android/camera/gallery/VideoList", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (VideoList); }
		}

		protected VideoList (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_ContentResolver_Landroid_net_Uri_ILjava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.android.camera.gallery']/class[@name='VideoList']/constructor[@name='VideoList' and count(parameter)=4 and parameter[1][@type='android.content.ContentResolver'] and parameter[2][@type='android.net.Uri'] and parameter[3][@type='int'] and parameter[4][@type='java.lang.String']]"
		[Register (".ctor", "(Landroid/content/ContentResolver;Landroid/net/Uri;ILjava/lang/String;)V", "")]
		public VideoList (global::Android.Content.ContentResolver p0, global::Android.Net.Uri p1, int p2, string p3) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			IntPtr native_p3 = JNIEnv.NewString (p3);;
			if (GetType () != typeof (VideoList)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Android.Camera.Gallery.VideoList __this = global::Java.Lang.Object.GetObject<global::Com.Android.Camera.Gallery.VideoList> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public override global::System.Collections.Generic.IDictionary<string, string> BucketIds {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.android.camera.gallery']/class[@name='VideoList']/method[@name='getBucketIds' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.android.camera.gallery']/class[@name='VideoList']/method[@name='createCursor' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.android.camera.gallery']/class[@name='VideoList']/method[@name='getImageId' and count(parameter)=1 and parameter[1][@type='android.database.Cursor']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.android.camera.gallery']/class[@name='VideoList']/method[@name='loadImageFromCursor' and count(parameter)=1 and parameter[1][@type='android.database.Cursor']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.android.camera.gallery']/class[@name='VideoList']/method[@name='whereClause' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.android.camera.gallery']/class[@name='VideoList']/method[@name='whereClauseArgs' and count(parameter)=0]"
