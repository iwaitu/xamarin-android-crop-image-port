...
namespace Emdroid {
	...
	public class EmCropImage : MonitoredActivity {
		...
		private Bitmap.CompressFormat OutputFormat { get; set; } = Bitmap.CompressFormat.Jpeg; // only used with mSaveUri
		private int OutputQuality { get; set; } = 100; // only used with mSaveUri and JPEG format
		private Android.Net.Uri SaveUri { get; set; } = null;
		public int AspectX { get; set; }
		public int AspectY { get; set; }
		public bool CircleCropping { get; set; } = false;
		public Handler MHandler { get; set; } = new Handler();
		public bool WaitingToPick { get; set; } = false;
		...
		private bool ShouldScaleUp { get; set; } = true;
		...
		public bool DoingFaceDetection { get; set; } = false;
